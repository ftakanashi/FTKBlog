...
SliderUnlock.prototype.init = function () {
    var a = this;
    a.updateView();
    a.elm.find(".slideunlock-label").on("mousedown", function (b) {
...
SliderUnlock.prototype.reset = function () {
    var a = this;
    a.index = 0;
    a.elm.find(".slideunlock-label").animate({left: a.index}, a.opts.duration).next(".slideunlock-label-tip").animate({opacity: 1}, a.opts.duration);
    a.updateView()
};
SliderUnlock.prototype.backgroundTranslate = function () {
    var a = this;
    a.elm.find(".slideunlock-label").css("left", a.index + "px").next(".slideunlock-label-tip").css("opacity", 1 - (parseInt($(".slideunlock-label").css("left")) / a.max))
};
SliderUnlock.prototype.updateView = function () {
    ...
    if (a.index == (a.max - 0)) {
        ...
        a.elm.addClass("success").find(".slideunlock-label-tip").html(a.opts.successLabelTip).css(b)
    } else {
        $(".slideunlock-lockable").val(0);
        a.elm.removeClass("success").find(".slideunlock-label-tip").html(a.opts.labelTip)
    }
    a.always()
};